...
mod tests {
	...
	fn test_from_word_and_to_word() {
		// Test with a known JAL instruction encoding
		let original_word = 0b0000_0000_0000_0000_0000_0000_1011_0111; // rd=1, imm=0, opcode=1101111
		let j = J::from_word(original_word);
		let reconstructed_word = j.to_word(0b1101111);
